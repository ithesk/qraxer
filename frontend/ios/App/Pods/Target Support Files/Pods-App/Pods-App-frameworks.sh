...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapgoCapacitorNativeBiometric/CapgoCapacitorNativeBiometric.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JcesarmobileCapacitorOcr/JcesarmobileCapacitorOcr.framework"
